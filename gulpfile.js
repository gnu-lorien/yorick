...
gulp.task('siteconfig-pubstorm', gulp.series('minify-js', function () {
...
gulp.task('siteconfig-patron', gulp.series('minify-js', function () {
    return gulp.src('./public/scripts/app/siteconfig.js')
...
gulp.task('siteconfig-heroku', gulp.series('minify-js', function () {
    return gulp.src('./public/scripts/app/siteconfig.js')
...
gulp.task('appbust', gulp.series('minify-js', function () {
...
gulp.task('indexbust', gulp.series('minify-html', function () {
