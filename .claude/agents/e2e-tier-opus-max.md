---
name: e2e-tier-opus-max
description: "Foundational E2E work with the widest blast radius: shared fixtures and helpers that every other task depends on. Implements numbered tests from testing_implementation_plan.md for the Yorick Playwright E2E suite."
