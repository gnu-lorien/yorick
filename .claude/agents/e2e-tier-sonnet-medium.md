---
name: e2e-tier-sonnet-medium
description: "E2E tasks that adapt an already-proven pattern to new surfaces: additional creature creation wizards, trait lifecycle parameterization, rename reflection. Implements numbered tests from testing_implementation_plan.md for the Yorick Playwright E2E suite."
